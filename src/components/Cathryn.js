...
const App = () => {
  ...
  const renderCards = () => {
    const cardData = [
      ...
      {
        text: `I'm so proud to have such an incredible person as my sister.`,
      },
      {
        text: `I have so many great memories with you, and I hope we can spend more time together in the future!`,
      },
      {
        text: 'I love you',
      },
